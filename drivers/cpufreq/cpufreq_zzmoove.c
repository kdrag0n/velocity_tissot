...
#if (defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) && !defined(DISABLE_POWER_MANAGEMENT)) || defined(CONFIG_STATE_NOTIFIER)
...
static struct notifier_block zzmoove_state_notif;
#endif /* defined(CONFIG_STATE_NOTIFIER)... */
...
#if defined(CONFIG_HAS_EARLYSUSPEND) && !defined(CONFIG_STATE_NOTIFIER)
static void __cpuinit powersave_early_suspend(struct early_suspend *handler)
#elif defined(CONFIG_POWERSUSPEND) && !defined(CONFIG_STATE_NOTIFIER) || defined(CONFIG_POWERSUSPEND) && defined(CONFIG_STATE_NOTIFIER)
...
#endif /* defined(CONFIG_HAS_EARLYSUSPEND)... */
{
	...
	* sampling_rate_asleep;							// ZZ: set sampling rate for sleep
	...
	scaling_up_block_cycles_count = 0;
#ifdef ZZMOOVE_DEBUG
	pr_info("[zzmoove/state_notifier] Suspend function executed.\n");
#endif /* ZZMOOVE_DEBUG */
}
...
#ifdef ZZMOOVE_DEBUG
	pr_info("[zzmoove/state_notifier] Resume function executed.\n");
#endif /* ZZMOOVE_DEBUG */
}

#if defined(CONFIG_HAS_EARLYSUSPEND) && !defined(CONFIG_STATE_NOTIFIER) && !defined(DISABLE_POWER_MANAGEMENT)
static struct early_suspend __refdata _powersave_early_suspend = {
  .suspend = powersave_early_suspend,
  .resume = powersave_late_resume,
  .level = EARLY_SUSPEND_LEVEL_BLANK_SCREEN,
};
#elif defined(CONFIG_POWERSUSPEND) && defined(CONFIG_STATE_NOTIFIER) && !defined (DISABLE_POWER_MANAGEMENT) || defined(CONFIG_POWERSUSPEND) && !defined(CONFIG_STATE_NOTIFIER) && !defined (DISABLE_POWER_MANAGEMENT)
...
#if (defined(CONFIG_STATE_NOTIFIER) && !defined(CONFIG_POWERSUSPEND))
// AP: callback handler for state notifier
static int state_notifier_call(struct notifier_block *this, unsigned long event, void *data)
{
	switch (event)
	{
		case STATE_NOTIFIER_SUSPEND:
			...
			if (!suspend_flag)
			    zzmoove_suspend();
#ifdef ZZMOOVE_DEBUG
			pr_info("[zzmoove/state_notifier] Screen switched off.\n");
#endif /* ZZMOOVE_DEBUG */
			break;
		...
		case STATE_NOTIFIER_ACTIVE:
			...
			if (suspend_flag)
			    zzmoove_resume();
#ifdef ZZMOOVE_DEBUG
			pr_info("[zzmoove/state_notifier] Screen switched on.\n");
#endif /* ZZMOOVE_DEBUG */
			break;
...
#if (defined(CONFIG_STATE_NOTIFIER) && !defined(CONFIG_POWERSUSPEND))
	// AP: register callback handler for state notifier
	zzmoove_state_notif.notifier_call = state_notifier_call;
	if (state_register_client(&zzmoove_state_notif) != 0) {
...
#if (defined(CONFIG_STATE_NOTIFIER) && !defined(CONFIG_POWERSUSPEND))
	state_unregister_client(&zzmoove_state_notif);
#endif /* (defined(CONFIG_STATE_NOTIFIER)... */
}
