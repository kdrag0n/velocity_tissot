...
ifeq ($(cc-name),clang)
KBUILD_CFLAGS   += -O3 -ffast-math -fno-signed-zeros -freciprocal-math -ffp-contract=fast -mno-unaligned-access -mstrict-align
# CPU optimization
...
KBUILD_CFLAGS	+= -Ofast -ffast-math -funsafe-math-optimizations -march=armv8-a+crypto+crc -mtune=cortex-a53 -mcpu=cortex-a53+crypto+crc
endif
endif
